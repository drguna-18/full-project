                ...
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    ...
                    <p className="lead mb-4">
                      Complete all your business compliance requirements in one
                      place - trade license, GST registration, environmental
                      clearance, and more.
                    </p>
                  ...
                  <div className="col-lg-6 mt-5 mt-lg-0 text-center">
                    <div class="image-container" id="imageContainer">
                      ...
                      />
                      <img
                        src="https://i.ytimg.com/vi/3AkjzDHuWKM/maxresdefault.jpg"
                        alt="Entrepreneur 4"
                      />
                      <img
                        src="https://thumbs.dreamstime.com/b/group-young-modern-people-smart-casual-wear-communicating-using-technologies-working-office-159237537.jpg"
                        alt="Entrepreneur 5"
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="card h-100">
                      <div className="card-body text-center p-4">
                        ...
                        <p className="text-muted mb-4">
                          Obtain necessary environmental permits and clearances
                          for your business operations.
                        </p>
                        <Link
                          to="/environmentalclearance"
                          className="btn btn-outline-primary"
                        >
                          Apply Now
                        </Link>
              ...
              <div class="container">
                <div class="text-center mb-5">
                  ...
                  <p class="lead text-muted">
                    We make business registration easy, fast, and hassle-free
                  </p>
                </div>
                  ...
                  <div class="col-lg-4">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted">
                          Get your business registrations processed quickly with
                          our streamlined systems.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted">
                          Ensure your business is fully compliant with all
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted">
                          Get guidance from our compliance experts throughout
                  ...
                  <div className="col-lg-4">
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted">
                          Easy-to-follow steps with clear instructions for all
                          registration forms.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted">
                          Save valuable time with our efficient registration
                          processes and pre-filled forms.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-4">
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted">
                          Secure storage for all your business registration
                ...
                <div className="row align-items-center">
                  <div className="col-lg-8 mb-4 mb-lg-0">
                    ...
                    <p className="lead mb-0">
                      Begin your business registration process today and get
                      compliant quickly.
                    </p>
                  </div>
